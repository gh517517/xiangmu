...
function bind(self, fn) {
  ...
  if (isFunction(fn) && !(fn instanceof RegExp)) {
    ...
    // in IE, native methods are not functions so they cannot be bound (note.txt.txt: they don't need to be)
    return fn;
  }
}
  ...
  this.$get = ['$filter', '$sniffer', function($filter, $sniffer) {
    ...
    function expressionInputDirtyCheck(newValue, oldValueOfValue) {
      ...
      if (typeof newValue === 'object') {
        ...
        // TODO(docs): add a note.txt.txt to docs that by implementing valueOf even objects and arrays can
...
function $SceProvider() {
   ...
   *
   *
   * A note.txt.txt on the inheritance model for SCE contexts
   * ------------------------------------------------
